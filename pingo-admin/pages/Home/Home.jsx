...
import { chartBoxClientes, chartBoxQuadra, barChartBoxLucro, chartBoxQuadrasPriv } from '../../data'
...
const Home = () => {
    return (
        <div className={styles.home}>
            ...
            <div className={`${styles.box} ${styles.box4}`}><ChartBox {...chartBoxQuadrasPriv}/></div>
