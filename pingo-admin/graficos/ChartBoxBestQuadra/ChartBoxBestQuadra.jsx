...
import styles from './ChartBoxBestQuadra.module.css'
import { Line, LineChart, ResponsiveContainer, Tooltip, XAxis } from 'recharts'
import { getQuadrasPrivData } from '../../api';


const ChartBoxBestQuadra = ({ color, icon, title, dataKey, url}) => {
    ...
    <div className={styles.chartBox}>
       <div className={styles.boxInfo}>
        ...
        <h3> Total Reservas: {data.totalQuadras}
        </h3>
...
export default ChartBoxBestQuadra