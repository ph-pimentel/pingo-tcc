...
import styles from './ChartBoxQuadrasPublicas.module.css'
import { Line, LineChart, ResponsiveContainer, Tooltip, XAxis } from 'recharts'
import { getQuadrasPublicasData } from '../../api';


const ChartBoxQuadrasPublicas = ({ color, icon, title, dataKey, url}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await getQuadrasPublicasData();
                setData({
...
export default ChartBoxQuadrasPublicas